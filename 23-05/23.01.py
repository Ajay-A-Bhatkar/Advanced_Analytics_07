...
# This answers: "What is the probability that a randomly selected passenger was female given that they survived?"
...
# This answers: "What is the probability that a randomly selected passenger was male given that they survived?"
p_male_given_survived = (p_survived_given_male * p_male) / p_survived
print(f"P(Gender = Male | Survived = 1) : {p_male_given_survived:.3f}") 
